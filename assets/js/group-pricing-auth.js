(function () {
  ...
  function init() {
    try {
      ...
      if (!gate || !main || !form || !nameInput || !phoneInput || !errEl || !submitBtn) {
        console.error("group-pricing-auth: required element missing, aborting init", {
          gate: !!gate, main: !!main, form: !!form, nameInput: !!nameInput,
          phoneInput: !!phoneInput, errEl: !!errEl, submitBtn: !!submitBtn
        });
        return;
      }
      ...
      console.error("group-pricing-auth: init failed", err);
    }
  }
