  ...
  function renderHeader(){
    ...
    mount.innerHTML =
      '<header class="he-header he-visible">'+
        ...
        '<div class="he-right">'+
          '<button type="button" class="he-theme-btn" id="he-theme-btn" aria-label="Toggle dark mode">'+
            '<svg class="he-icon-sun" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"/></svg>'+
            '<svg class="he-icon-moon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79Z"/></svg>'+
          '</button>'+
    ...
    var themeBtn = document.getElementById('he-theme-btn');
    if(themeBtn){
